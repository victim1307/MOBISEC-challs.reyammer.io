...
public class ActionMenuPresenter extends BaseMenuPresenter implements ActionProvider.SubUiVisibilityListener {
    ...
    public boolean flagActionItems() {
        ...
        if (actionMenuPresenter.mStrictWidthLimit) {
            i2 = i6 / actionMenuPresenter.mMinCellSize;
            i3 = ((i6 % actionMenuPresenter.mMinCellSize) / i2) + actionMenuPresenter.mMinCellSize;
        } else {
            i2 = 0;
            i3 = 0;
        }
        ...
        while (i14 < i) {
            ...
            if (menuItemImpl2.requiresActionButton()) {
                ...
                if (actionMenuPresenter.mStrictWidthLimit) {
                    i2 -= ActionMenuView.measureChildForCells(itemView, i3, i2, makeMeasureSpec, r2);
                } else {
                ...
                if (z5) {
                    ...
                    z5 = actionMenuPresenter.mStrictWidthLimit ? z6 & (i13 >= 0) : z6 & (i13 + i12 > 0);
                } else {
                    i4 = i;
                }
                if (z5 && groupId2 != 0) {
